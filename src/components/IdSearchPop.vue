      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="modalTopBox">
            <ul>
              <li><div>아래 사업자등록번호, 찾고자 하는 로그인 사용자명 그리고 등록된 이메일을 정확히 입력하셔야 이메일 및 문자로 아이디를 발송합니다.</div></li>
          ...
          <div class="flex align-items-center mt30">
            ...
            <div class="flex align-items-center width100">
              <input type="text" v-model="idSearch.regnum1" maxlength="3" class="inputStyle">
              <span style="margin:0 10px">-</span>
              <input type="text" v-model="idSearch.regnum2" maxlength="2" class="inputStyle">
              <span style="margin:0 10px">-</span>
              <input type="text" v-model="idSearch.regnum3" maxlength="5" class="inputStyle">
            </div>
          </div>
          ...
          <div class="flex align-items-center mt10">
            ...
            <div class="flex align-items-center width100">
              <input type="text" v-model.trim="idSearch.userEmail" class="inputStyle" placeholder="ex) sample@iljin.co.kr">
            </div>
          </div>
  ...
  <div class="modal fade modalStyle" id="idSearchConfirm" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width:100%; max-width:420px">
      <div class="modal-content">
        <div class="modal-body">
          <a href="#" class="ModalClose" data-dismiss="modal" title="닫기"><i class="fa-solid fa-xmark"></i></a>
          <div class="alertText2">입력하신 사용자에게 문자와 이메일로 e-bidding 시스템에 접속하실 아이디를 전송합니다.<br>아이디를 전송하시겠습니까?</div>
          <div class="modalFooter">
...
export default {
  ...
  watch : {
    // 사업자 등록번호
    'idSearch.regnum1'(){
      this.idSearch.regnum1 = this.idSearch.regnum1.replace(/[^0-9]/g, '').trim();
    },
    'idSearch.regnum2'(){
      this.idSearch.regnum2 = this.idSearch.regnum2.replace(/[^0-9]/g, '').trim();
    },
    'idSearch.regnum3'(){
      this.idSearch.regnum3 = this.idSearch.regnum3.replace(/[^0-9]/g, '').trim();
    }
  },
  methods: {
    initModal() {
