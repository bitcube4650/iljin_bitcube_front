            ...
            <div class="formWidth">
                ...
                <div class="boxSt mt20">
                    ...
                    <div class="flex align-items-center mt20">
                        ...
                        <div class="width100">입찰 사양 변경으로 유찰합니다.</div>
                    </div>
                </div>
                ...
                <div class="boxSt mt20">
                    ...
                    <div class="flex align-items-center mt20">
                        ...
                        <div class="width100">일백만원에 낙찰함</div>
                    </div>
                </div>

                <div class="text-center mt50">
                    <a href="javascript:void(0)" class="btnStyle btnOutline" title="목록">목록</a>
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#resultsReport2" class="btnStyle btnPrimary" title="입찰결과 보고서">입찰결과 보고서</a>
                </div>
            </div>
        </div>
        <!-- //contents -->
