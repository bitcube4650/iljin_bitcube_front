        ...
        <div class="contents">
            <div class="formWidth">
                ...
                <div class="text-center mt50">
                    ...
                    <a v-if="data.ingTag == 'A1' && (data.bidAuth || data.openAuth || (data.createUser == $store.state.loginInfo))" data-toggle="modal" data-target="#biddingReserve" class="btnStyle btnSecondary" title="유찰">유찰</a>
