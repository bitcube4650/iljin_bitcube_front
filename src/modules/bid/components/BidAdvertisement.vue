<template>
    <!-- 공고문 미리보기 -->
    <div class="modal fade modalStyle" id="biddingPreview" tabindex="-1" role="dialog" aria-hidden="true">
				...
				<div class="modal-body">
					...
					<div class="modalBoxSt mt10">
						...
						<div class="flex align-items-center mt10">
							...
							<div class="width100">생산2파트</div>
						</div>
					</div>

					<h4 class="h4Tit mt20">라. 전자입찰 등록서류</h4>
					<div class="modalBoxSt mt10">
						<div class="flex align-items-center">
					...
					<div class="modalFooter">
						...
						<a href="javascript:void(0)" class="modalBtnCheck" data-toggle="modal" title="인쇄하기">인쇄하기</a>
					</div>
				</div>				
			</div>
		</div>
