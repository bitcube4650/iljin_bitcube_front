    ...
    <div class="modal-dialog" style="width: 100%; max-width: 800px">
      <div class="modal-content">
        <div class="modal-body">
          ...
          ></a>
          <h2 class="modalTitle">낙찰자 조회</h2>
          <div class="modalTopBox">
            <ul>
              <li>
                <div>
                  소속사의 낙찰권한을 가진 사용자만 조회됩니다. (사용자 조회 후
                  선택버튼을 누르십시오)
                </div>
              </li>
              <li>
...
export default {
  ...
  methods: {
    initModal(data) {
      this.searchParams = {
        size: "5",
        type: "biddingUser", //openBidUser: 개찰유저 검색, biddingUser: 낙찰유저 검색, normalUser: 이외
        interrelatedCD:data 
      };
      this.search(0);
    },
