        ...
        <div class="inner">
            ...
            <div class="boxSt mt20">
                ...
                <div class="flex align-items-center mt10">
                    ...
                    <div class="flex align-items-center width100">
                        <input type="text" v-model="detail.capital" maxlength="15" class="inputStyle" placeholder="ex) 10,000,000">
                ...
                <div class="flex align-items-center mt10">
                    ...
                    <div class="flex align-items-center width100">
                        <input type="text" v-model="detail.foundYear" maxlength="4" class="inputStyle" placeholder="ex) 2021">
                ...
                <div class="flex align-items-center mt10">
                    ...
                    <div class="width100">
                        <input type="text" v-model.trim="detail.tel" maxlength="13" class="inputStyle" >
                    </div>
                </div>
                <div class="flex align-items-center mt10">
                    <div class="formTit flex-shrink0 width170px">팩스</div>
                    <div class="width100">
                        <input type="text" v-model.trim="detail.fax" maxlength="13" class="inputStyle">
                    </div>
                </div>
                <div class="flex mt10">
            ...
            <div class="boxSt mt20">
                ...
                <div class="flex align-items-center mt10">
                    ...
                    <div class="flex align-items-center width100">
                        <input type="text" v-model.trim="detail.userId" maxlength="10" class="inputStyle" placeholder="영문, 숫자 입력(10자 이내) 후 중복확인">
                ...
                <div class="flex align-items-center mt10">
                    ...
                    <div class="width100">
                        <input type="text" v-model.trim="detail.userHp" maxlength="13" class="inputStyle">
                    </div>
                </div>
                <div class="flex align-items-center mt10">
                    <div class="formTit flex-shrink0 width170px">유선전화 <span class="star">*</span></div>
                    <div class="width100">
                        <input type="text" v-model.trim="detail.userTel" maxlength="13" class="inputStyle">
                    </div>
                </div>
                <div class="flex align-items-center mt10">
...
export default {
  ...
  methods: {
		...
		validate() {  
			...
			if (this.detail.capital == null || this.detail.capital == '' || this.detail.capital == 0) {
