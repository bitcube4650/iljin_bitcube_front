...
nxTSPKIConfig.installPage            = "https://pkidemo.tradesign.net/NXTSDemo/NXTSDemo_1.0.1.5/";
nxTSPKIConfig.installMessage         = "SCORE PKI for OpenWeb 프로그램이 설치 되어 있지 않거나, 이전 버전이 설치되어 있습니다. SCORE PKI for OpenWeb의 OpenWeb 프로그램을 다운로드 해주세요. \n\n다운로드 화면으로 이동하시겠습니까?";
