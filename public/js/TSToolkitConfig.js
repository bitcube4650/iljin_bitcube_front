...
//** 기본정보 설정			************************************************************//
// CMP
CA_TYPE_YESSIGN		: 4,		// 금결원
CA_TYPE_SIGNKOREA 	: 8,		// 증권전산
CA_TYPE_SIGNGATE 	: 16,		// 정보인증
CA_TYPE_CROSSCERT	: 32,		// 전자인증
CA_TYPE_NCASIGN		: 64,		// 전산원
CA_TYPE_TRADESIGN	: 128,		// KTNET
CA_TYPE_ALL			: 255,		// 모든 인증기관 인증서

CA_URL 		: "localhost:8080/nca-web",
//var CA_CERT_URL = "http://testca.tradesign.net/cert/TradeSignCA2011Test2.der";
CA_CERT_URL : "http://testca.tradesign.net/cert/SHA2CAOper.der",
...
pemSignCert, pemSignKey, pemKMCert, pemKMKey,
...
export function escape_url(url) {
	var i;
	var ch;
	var out = '';
	var url_string = '';
